    ...
    <Container>
      ...
      />
      {
        <div className="recommend__donar">
          ...
          <Carousel>
                <div>
                    <p className="legend">Rajat recommended Amisha for donor</p>
                </div>
                <div>
                    <p className="legend">Arpit recommended Kanika for donor</p>
                </div>
                <div>
                    <p className="legend">Akshit recommended Tanya for donor</p>
                </div>
            </Carousel>
          </div> */}
